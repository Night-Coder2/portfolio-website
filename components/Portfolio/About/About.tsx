    ...
    <div id='about' className='w-full h-full p-2 flex items-center py-16'>
        <motion.div ref={ref} variants={container} initial={"hidden"} animate={controls} className='max-w-[1240px] m-auto lg:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <motion.h2 className='py-10'>Chess</motion.h2>
                <motion.p variants={item} className='py-2'>
                    I started playing chess in 2022. I had a different taste for chess I learnt it very fast and I play quite well in my <Link href='https://discord.gg/uquRPXkcnU' target={"_blank"} className='text-blue-500'>Discord</Link> server
                </motion.p>
